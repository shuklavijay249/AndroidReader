...
public class Chapter2 extends AppCompatActivity {
    ...
    private static final String TAG = "Chapter2";
...
*/
    ...
    public void onBackPressed() {
        super.onBackPressed();
        try {
            Intent backpagecall=new Intent(mcontext, com.example.androidreader.MainActivity.class);
