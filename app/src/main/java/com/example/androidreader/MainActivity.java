    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  titleArrayList.add(Constant.INTRODUCTION);
       ...
       // titleArrayList.add(Constant.CHAPTER10);
        ...
        imgTitleList.add(R.drawable.ic_android);
        imgTitleList.add(R.drawable.ic_tools);
        imgTitleList.add(R.drawable.ic_java);
        imgTitleList.add(R.drawable.ic_projectdiagram);
        imgTitleList.add(R.drawable.ic_puzzlepiece);
        imgTitleList.add(R.drawable.ic_playcircle);
        imgTitleList.add(R.drawable.ic_windowalt);
        imgTitleList.add(R.drawable.ic_mapmarkalt);
        ...
        try {
            ...
            com.example.androidreader.TitleAdapter adapter1 = new TitleAdapter(mcontext, titleArrayList, sbtitleArrayList, imgTitleList,new CustomItemClickListner() {
